    ...
    try {
      ...
      if (filters.productionStatuses?.length) {
        params.append(
          ...
          filters.productionStatuses.join(','),
        );
        activeFiltersCount += 1;
      }
      ...
      const response = await axios.get<ApiResponse>(
        `${ANILIBRIA_API_URL}/anime/catalog/releases?${params.toString()}`,
      );
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-2">
                      <Form.Item
                        name="search"
                        label={
                          <span className="text-xs text-white">Поиск</span>
                        }
                      ...
                      <Form.Item
                        name="sorting"
                        label={
                          <span className="text-xs text-white">Сортировка</span>
                        }
                        style={{ marginBottom: '8px' }}
                      >
                        <Select
                      ...
                      <Form.Item
                        name="types"
                        label={<span className="text-xs text-white">Типы</span>}
                        style={{ marginBottom: '8px' }}
                      >
                        <Select
                          mode="multiple"
                      ...
                      <Form.Item
                        name="seasons"
                        label={
                          <span className="text-xs text-white">Сезоны</span>
                        }
                        style={{ marginBottom: '8px' }}
                      >
                        <Select
                      ...
                      <div className="flex space-x-1">
                        <Form.Item
                          name="fromYear"
                          label={<span className="text-xs text-white">От</span>}
                          className="w-1/2"
                          style={{ marginBottom: '8px' }}
                        >
                          <Select
                        ...
                        <Form.Item
                          name="toYear"
                          label={<span className="text-xs text-white">До</span>}
                          className="w-1/2"
                          style={{ marginBottom: '8px' }}
                        >
                          <Select
